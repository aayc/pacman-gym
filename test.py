...
from env import ActionType, PacmanEnv
    ...
    try:
        while True:
            ...
            if step_count % 50 == 0:
                ...
                print(
                    f"  Rewards: Pacman={rewards[0]:.2f}, Ghost1={rewards[1]:.2f}, Ghost2={rewards[2]:.2f}"
                )
                print()
            ...
            if done or truncated:
                ...
                print(
                    f"  Final rewards: Pacman: {episode_rewards[0]:.2f}, Ghost1: {episode_rewards[1]:.2f}, Ghost2: {episode_rewards[2]:.2f}"
                )
                print(f"  Pacman final score: {env.pacman.score}")
                print(
                    f"  Pellets collected: {env.pellets_collected}/{env.total_pellets}"
                )
...
def test_observations():
    ...
    print(f"  Observation shape: {obs.shape}")
    print("  Expected: (3, 38) for [Pacman, Ghost1, Ghost2]")
